...
#include "normalsetmechrotationtracecmd_fuzzer.h"
...
void FuzzConstructor(FuzzedDataProvider &provider)
{
    ...
    size_t paramCount = provider.ConsumeIntegralInRange<size_t>(0, CMD_MAX_POINT_SIZE);
    ...
    NormalSetMechRotationTraceCmd cmd(taskId, params);
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    int32_t testFunctionId = provider.ConsumeIntegralInRange<int32_t>(0, 7);
