...
/**
 * @tc.name  : FilterDetectedObject_001
 * @tc.number: FilterDetectedObject_001
 * @tc.desc  : Testing FilterDetectedObject with FACE type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_001, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_001 begin" << std::endl;
    ...
    bool result = controller.FilterDetectedObject(mockObject);
    EXPECT_TRUE(result);

    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_001 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_002
 * @tc.number: FilterDetectedObject_002
 * @tc.desc  : Testing FilterDetectedObject with HUMAN_BODY type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_002, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_002 begin" << std::endl;
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_002 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_003
 * @tc.number: FilterDetectedObject_003
 * @tc.desc  : Testing FilterDetectedObject with INVALID type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_003, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_003 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::INVALID,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_003 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_004
 * @tc.number: FilterDetectedObject_004
 * @tc.desc  : Testing FilterDetectedObject with CAT_FACE type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_004, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_004 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::CAT_FACE,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_004 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_005
 * @tc.number: FilterDetectedObject_005
 * @tc.desc  : Testing FilterDetectedObject with CAT_BODY type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_005, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_005 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::CAT_BODY,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_005 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_006
 * @tc.number: FilterDetectedObject_006
 * @tc.desc  : Testing FilterDetectedObject with DOG_FACE type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_006, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_006 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::DOG_FACE,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_006 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_007
 * @tc.number: FilterDetectedObject_007
 * @tc.desc  : Testing FilterDetectedObject with DOG_BODY type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_007, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_006 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::DOG_BODY,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_007 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_008
 * @tc.number: FilterDetectedObject_008
 * @tc.desc  : Testing FilterDetectedObject with SALIENT_DETECTION type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_008, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_008 begin" << std::endl;
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_008 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_009
 * @tc.number: FilterDetectedObject_009
 * @tc.desc  : Testing FilterDetectedObject with BAR_CODE_DETECTION type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_009, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_009 begin" << std::endl;
    ...
    int64_t timestamp = 0;
    sptr<CameraStandard::MetadataObject> mockObject =
        new CameraStandard::MetadataObject(CameraStandard::MetadataObjectType::BAR_CODE_DETECTION,
            timestamp,
            targetRect,
            100,
            0
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_009 end" << std::endl;
}

/**
 * @tc.name  : FilterDetectedObject_010
 * @tc.number: FilterDetectedObject_010
 * @tc.desc  : Testing FilterDetectedObject with BASE_FACE_DETECTION type.
 */
HWTEST_F(McCameraTrackingControllerTwoTest, FilterDetectedObject_010, TestSize.Level1)
{
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_010 begin" << std::endl;
    ...
    DTEST_LOG << "McCameraTrackingControllerTwoTest FilterDetectedObject_010 end" << std::endl;
}
