...
HWTEST_F(MotionManagerTwoTest, MechTrackingStatusNotify_004, TestSize.Level1)
{
    ...
    cmd->isEnabled_ = true;
    EXPECT_NO_FATAL_FAILURE(motionMgr->MechTrackingStatusNotify(cmd));
...
HWTEST_F(MotionManagerTwoTest, ProcessTrackingStatus_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->ProcessTrackingStatus());
}
...
HWTEST_F(MotionManagerTwoTest, TrackingChecker_002, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->TrackingChecker());
}
...
/**
 * @tc.name  : HandlePhoneOff_001
 * @tc.number: HandlePhoneOff_001
 * @tc.desc  : Test HandlePhoneOff function.
 */
HWTEST_F(MotionManagerTwoTest, HandlePhoneOff_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->HandlePhoneOff(false));
}
...
HWTEST_F(MotionManagerTwoTest, HandlePhoneOn_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->HandlePhoneOn(true));
}
...
HWTEST_F(MotionManagerTwoTest, ConnectAbility_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->ConnectAbility());
}

/**
 * @tc.name  : SetProtocolVer_001
 * @tc.number: SetProtocolVer_001
 * @tc.desc  : Test SetProtocolVer function.
 */
 ...
 * @tc.desc  : Test GetMechRealName function.
 */
HWTEST_F(MotionManagerTwoTest, GetMechRealName_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->GetMechRealName());
}
...
/**
 * @tc.name  : GetDeviceCapabilityInfo_001
 * @tc.number: GetDeviceCapabilityInfo_001
 * @tc.desc  : Test GetDeviceCapabilityInfo function.
 */
HWTEST_F(MotionManagerTwoTest, GetDeviceCapabilityInfo_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
 ...
 * @tc.desc  : Test GetDeviceStateInfo function.
 */
HWTEST_F(MotionManagerTwoTest, GetDeviceStateInfo_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->GetDeviceStateInfo());
}

/**
 * @tc.name  : GetMechLimitInfo_001
 * @tc.number: GetMechLimitInfo_001
 * @tc.desc  : Test GetMechLimitInfo function.
 */
HWTEST_F(MotionManagerTwoTest, GetMechLimitInfo_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->GetMechLimitInfo());
}

/**
 * @tc.name  : GetWheelCapabilityInfo_001
 * @tc.number: GetWheelCapabilityInfo_001
 * @tc.desc  : Test GetWheelCapabilityInfo function.
 */
HWTEST_F(MotionManagerTwoTest, GetWheelCapabilityInfo_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->GetWheelCapabilityInfo());
}

/**
 * @tc.name  : RegisterBaseEvents_001
 * @tc.number: RegisterBaseEvents_001
 * @tc.desc  : Test RegisterBaseEvents function.
 */
HWTEST_F(MotionManagerTwoTest, RegisterBaseEvents_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->RegisterBaseEvents());
}
...
HWTEST_F(MotionManagerTwoTest, RegisterEventListenerV01_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->RegisterEventListenerV01());
}

/**
 * @tc.name  : StartEvent_001
 * @tc.number: StartEvent_001
 * @tc.desc  : Test StartEvent function.
 */
...
HWTEST_F(MotionManagerTwoTest, UpdateTrackingTime_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->UpdateTrackingTime());
}

/**
 * @tc.name  : SetDeviceRealName_001
 * @tc.number: SetDeviceRealName_001
 * @tc.desc  : Test SetDeviceRealName function.
 */
HWTEST_F(MotionManagerTwoTest, SetDeviceRealName_001, TestSize.Level1)
{
    int32_t mechId = 100;
    std::shared_ptr<MotionManager> motionMgr =
        std::make_shared<MotionManager>(std::make_shared<TransportSendAdapter>(), mechId);
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->SetDeviceRealName(deviceRealName));
}
...
HWTEST_F(MotionManagerTwoTest, CheckYawDegree_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckYawDegree(rotateParam, limit, yawResult));
}
...
HWTEST_F(MotionManagerTwoTest, CheckRollDegree_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckRollDegree(rotateParam, limit, rollResult));
}
...
HWTEST_F(MotionManagerTwoTest, CheckPitchDegree_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckPitchDegree(rotateParam, limit, pitchResult));
}
...
HWTEST_F(MotionManagerTwoTest, CheckYawSpeed_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckYawSpeed(rotateBySpeedParam, limit, yawResult));
}
...
HWTEST_F(MotionManagerTwoTest, CheckRollSpeed_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckRollSpeed(rotateBySpeedParam, limit, rollResult));
}
...
HWTEST_F(MotionManagerTwoTest, CheckPitchSpeed_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CheckPitchSpeed(rotateBySpeedParam, limit, pitchResult));
}
...
HWTEST_F(MotionManagerTwoTest, HandelRotateParam_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->HandelRotateParam(rotateParam, willLimitChange));
}
...
HWTEST_F(MotionManagerTwoTest, CreateAndSendRotateBySpeedCommand_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->CreateAndSendRotateBySpeedCommand(rotateSpeedParam, responseTaskId));
}
...
HWTEST_F(MotionManagerTwoTest, HandelRotateSpeedParam_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->HandelRotateSpeedParam(rotateBySpeedParam, willLimitChange));
}
...
HWTEST_F(MotionManagerTwoTest, ExecuteRotateCommand_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->ExecuteRotateCommand(param, taskId));
}
...
HWTEST_F(MotionManagerTwoTest, SendRotateCommandImpl_001, TestSize.Level1)
{
    ...
    EXPECT_NO_FATAL_FAILURE(motionMgr->SendRotateCommandImpl(responseTaskId, rotateTaskId, rotateParams));
}
