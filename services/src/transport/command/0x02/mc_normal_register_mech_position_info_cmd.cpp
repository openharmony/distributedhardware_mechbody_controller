...
namespace {
    const std::string TAG = "NormalRegisterMechPositionInfoCmd";
}

NormalRegisterMechPositionInfoCmd::NormalRegisterMechPositionInfoCmd()
{
    cmdSet_ = CMD_SET;
    cmdId_ = CMD_ID;
    reqSize_ = REQ_SIZE;
...
std::shared_ptr<MechDataBuffer> NormalRegisterMechPositionInfoCmd::Marshal() const
{
    HILOGI("start.");
...
bool NormalRegisterMechPositionInfoCmd::Unmarshal(std::shared_ptr<MechDataBuffer> data)
{
    HILOGD("start.");
    ...
    CHECK_ERR_RETURN_VALUE(data->ReadUint8(offset, limitStatus_), false, "read limitStatus");
    HILOGI("get limitStatus: %{public}u", limitStatus_);
    offset++;
...
void NormalRegisterMechPositionInfoCmd::TriggerResponse(std::shared_ptr<MechDataBuffer> data)
{
    HILOGI("start.");
...
const EulerAngles& NormalRegisterMechPositionInfoCmd::GetPosition() const
{
    return position_;
}

uint8_t NormalRegisterMechPositionInfoCmd::GetResult() const
{
    return result_;
}
} // namespace MechBodyController
