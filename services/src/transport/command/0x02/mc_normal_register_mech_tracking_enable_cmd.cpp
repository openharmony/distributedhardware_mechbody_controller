...
namespace {
    const std::string TAG = "NormalRegisterMechTrackingEnableCmd";
}

NormalRegisterMechTrackingEnableCmd::NormalRegisterMechTrackingEnableCmd()
{
    cmdSet_ = CMD_SET;
    cmdId_ = CMD_ID;
    reqSize_ = REQ_SIZE;
...
std::shared_ptr<MechDataBuffer> NormalRegisterMechTrackingEnableCmd::Marshal() const
{
    HILOGI("start.");
...
bool NormalRegisterMechTrackingEnableCmd::Unmarshal(std::shared_ptr<MechDataBuffer> data)
{
    HILOGD("start.");
...
void NormalRegisterMechTrackingEnableCmd::TriggerResponse(std::shared_ptr<MechDataBuffer> data)
{
    HILOGI("start.");
...
bool NormalRegisterMechTrackingEnableCmd::GetIsEnabled() const
{
    return isEnabled_;
}

uint8_t NormalRegisterMechTrackingEnableCmd::GetResult() const
{
    return result_;
}
} // namespace MechBodyController
