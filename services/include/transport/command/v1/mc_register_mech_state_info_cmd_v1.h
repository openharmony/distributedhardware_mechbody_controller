 ...
 */
#ifndef MC_REGISTER_MECH_STATE_INFO_CMD_V1_H
#define MC_REGISTER_MECH_STATE_INFO_CMD_V1_H
...
class RegisterMechStateInfoCmdV1 : public RegisterMechStateInfoCmd {
public:
    ...
    explicit RegisterMechStateInfoCmdV1();
    ~RegisterMechStateInfoCmdV1() override = default;
...
#endif // MC_REGISTER_MECH_STATE_INFO_CMD_V1_H
