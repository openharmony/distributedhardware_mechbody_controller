...
#ifndef MC_GET_MECH_CAPABILITY_INFO_CMD_V1_H
#define MC_GET_MECH_CAPABILITY_INFO_CMD_V1_H
...
class GetMechCapabilityInfoCmdV1 : public GetMechCapabilityInfoCmd {
public:
    ...
    explicit GetMechCapabilityInfoCmdV1();
    ~GetMechCapabilityInfoCmdV1() override = default;
...
#endif // MC_GET_MECH_CAPABILITY_INFO_CMD_V1_H
