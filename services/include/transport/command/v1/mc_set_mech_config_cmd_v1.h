...
#ifndef MC_SET_MECH_CONFIG_CMD_V1_H
#define MC_SET_MECH_CONFIG_CMD_V1_H
...
class SetMechConfigCmdV1 : public SetMechConfigCmd {
public:
    explicit SetMechConfigCmdV1(uint8_t configVersion);
    ~SetMechConfigCmdV1() override = default;
...
#endif // MC_SET_MECH_CONFIG_CMD_V1_H
