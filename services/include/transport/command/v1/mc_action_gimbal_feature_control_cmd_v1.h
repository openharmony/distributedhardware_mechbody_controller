 ...
 */
#ifndef MC_ACTION_GIMBAL_FEATURE_CONTROL_CMD_V1_H
#define MC_ACTION_GIMBAL_FEATURE_CONTROL_CMD_V1_H
...
class ActionGimbalFeatureControlCmdV1 : public ActionGimbalFeatureControlCmd {
public:
    ...
    explicit ActionGimbalFeatureControlCmdV1(const ActionControlParams &params);
    ~ActionGimbalFeatureControlCmdV1() override = default;
...
#endif // MC_ACTION_GIMBAL_FEATURE_CONTROL_CMD_V1_H
