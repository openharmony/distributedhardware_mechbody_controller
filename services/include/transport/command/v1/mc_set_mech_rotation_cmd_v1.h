...
#ifndef MC_SET_MECH_ROTATION_CMD_V1_H
#define MC_SET_MECH_ROTATION_CMD_V1_H
...
class SetMechRotationCmdV1 : public SetMechRotationCmd {
public:
    ...
    explicit SetMechRotationCmdV1(const RotateParam& params);
    ~SetMechRotationCmdV1() override = default;
...
#endif // MC_SET_MECH_ROTATION_CMD_V1_H
