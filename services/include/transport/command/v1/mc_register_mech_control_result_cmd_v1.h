 ...
 */
#ifndef MC_REGISTER_MECH_CONTROL_RESULT_CMD_V1_H
#define MC_REGISTER_MECH_CONTROL_RESULT_CMD_V1_H
...
class RegisterMechControlResultCmdV1 : public RegisterMechControlResultCmd {
public:
    static constexpr uint8_t CMD_SET = 0x02;
    static constexpr uint8_t CMD_ID = 0x43;
    static constexpr uint16_t REQ_SIZE = 0;
    static constexpr uint16_t RSP_SIZE = 0;
    static constexpr uint16_t RPT_SIZE = 1;

    explicit RegisterMechControlResultCmdV1();
    ~RegisterMechControlResultCmdV1() override = default;
    ...
    uint8_t GetControlResult() const override;
...
#endif // MC_REGISTER_MECH_CONTROL_RESULT_CMD_V1_H
