...
#ifndef MC_SET_MECH_ROTATION_TRACE_CMD_V1_H
#define MC_SET_MECH_ROTATION_TRACE_CMD_V1_H
...
class SetMechRotationTraceCmdV1 : public SetMechRotationTraceCmd {
public:
    ...
    explicit SetMechRotationTraceCmdV1(const std::vector<RotateParam>& params);
    ~SetMechRotationTraceCmdV1() override = default;
...
#endif // MC_SET_MECH_ROTATION_TRACE_CMD_V1_H
