...
#ifndef MC_GET_MECH_PROTOCOL_VER_CMD_H
#define MC_GET_MECH_PROTOCOL_VER_CMD_H
...
class GetMechProtocolVerCmd : public CommandBase {
public:
    ...
    explicit GetMechProtocolVerCmd();
    ~GetMechProtocolVerCmd() override = default;
...
private:
    uint8_t highProtocolVer_;
    uint8_t lowProtocolVer_;
    uint8_t result_ = 0;
};
...
#endif // MC_GET_MECH_PROTOCOL_VER_CMD_H
