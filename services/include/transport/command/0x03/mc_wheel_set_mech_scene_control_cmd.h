 ...
 */
#ifndef MC_WHEEL_SET_MECH_SCENE_CONTROL_CMD_H
#define MC_WHEEL_SET_MECH_SCENE_CONTROL_CMD_H
...
class WheelSetMechSceneControlCmd : public CommandBase {
public:
    ...
    explicit WheelSetMechSceneControlCmd(ActionType doAction);
    ~WheelSetMechSceneControlCmd() override = default;
...
#endif // MC_WHEEL_SET_MECH_SCENE_CONTROL_CMD_H
