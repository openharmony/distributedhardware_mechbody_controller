...
#ifndef MC_REGISTER_MECH_CLIFF_INFO_CMD_H
#define MC_REGISTER_MECH_CLIFF_INFO_CMD_H
...
class RegisterMechCliffInfoCmd : public CommandBase {
public:
    ...
    explicit RegisterMechCliffInfoCmd();
    ~RegisterMechCliffInfoCmd() override = default;
    ...
    const std::vector<CliffInfo> GetCliffs() const;
    uint8_t GetCliffNums() const;
...
#endif // MC_REGISTER_MECH_CLIFF_INFO_CMD_H
