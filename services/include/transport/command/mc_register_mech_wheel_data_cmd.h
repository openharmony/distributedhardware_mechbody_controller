 ...
 */
#ifndef MC_REGISTER_MECH_WHEEL_DATA_CMD_H
#define MC_REGISTER_MECH_WHEEL_DATA_CMD_H
...
class RegisterMechWheelDataCmd : public CommandBase {
public:
    ...
    explicit RegisterMechWheelDataCmd();
    ~RegisterMechWheelDataCmd() override = default;
...
#endif // MC_REGISTER_MECH_WHEEL_DATA_CMD_H
