...
#ifndef MC_SET_MECH_STOP_CMD_H
#define MC_SET_MECH_STOP_CMD_H
...
class SetMechStopCmd : public CommandBase {
public:
    ...
    SetMechStopCmd();
    ~SetMechStopCmd() override = default;
