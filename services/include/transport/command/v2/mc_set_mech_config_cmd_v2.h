...
#ifndef MC_SET_MECH_CONFIG_CMD_V2_H
#define MC_SET_MECH_CONFIG_CMD_V2_H
...
class SetMechConfigCmdV2 : public SetMechConfigCmd {
public:
    ...
    explicit SetMechConfigCmdV2(uint8_t configVersion);
    ~SetMechConfigCmdV2() override = default;
...
#endif // MC_SET_MECH_CONFIG_CMD_V2_H
