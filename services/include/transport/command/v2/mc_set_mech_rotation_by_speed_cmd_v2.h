...
#ifndef MC_SET_MECH_ROTATION_BY_SPEED_CMD_V2_H
#define MC_SET_MECH_ROTATION_BY_SPEED_CMD_V2_H
...
class SetMechRotationBySpeedCmdV2 : public SetMechRotationBySpeedCmd {
public:
    ...
    explicit SetMechRotationBySpeedCmdV2(const RotateBySpeedParam& params);
    ~SetMechRotationBySpeedCmdV2() override = default;
...
#endif // MC_SET_MECH_ROTATION_BY_SPEED_CMD_V2_H
