...
#ifndef MC_GET_MECH_BASIC_INFO_CMD_V2_H
#define MC_GET_MECH_BASIC_INFO_CMD_V2_H
...
class GetMechBasicInfoCmdV2 : public GetMechBasicInfoCmd {
public:
    static constexpr uint8_t CMD_SET = 0x01;
    static constexpr uint8_t CMD_ID = 0x01;
    static constexpr uint16_t REQ_SIZE = 3;

    explicit GetMechBasicInfoCmdV2();
    ~GetMechBasicInfoCmdV2() override = default;
...
#endif // MC_GET_MECH_BASIC_INFO_CMD_V2_H
