...
#ifndef MC_SET_MECH_ROTATION_BY_SPEED_CMD_V1_H
#define MC_SET_MECH_ROTATION_BY_SPEED_CMD_V1_H
...
class SetMechRotationBySpeedCmdV1 : public SetMechRotationBySpeedCmd {
public:
    ...
    explicit SetMechRotationBySpeedCmdV1(const RotateBySpeedParam& params);
    ~SetMechRotationBySpeedCmdV1() override = default;
...
#endif // MC_SET_MECH_ROTATION_BY_SPEED_CMD_V1_H
