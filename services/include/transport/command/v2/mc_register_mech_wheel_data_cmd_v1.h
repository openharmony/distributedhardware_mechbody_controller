 ...
 */
#ifndef MC_REGISTER_MECH_WHEEL_DATA_CMD_V1_H
#define MC_REGISTER_MECH_WHEEL_DATA_CMD_V1_H
...
class RegisterMechWheelDataCmdV1 : public RegisterMechWheelDataCmd {
public:
    static constexpr uint8_t CMD_SET = 0x02;
    static constexpr uint8_t CMD_ID = 0x44;
    static constexpr uint16_t REQ_SIZE = 0;
    static constexpr uint16_t RSP_SIZE = 0;
    static constexpr uint16_t RPT_SIZE = 5;

    explicit RegisterMechWheelDataCmdV1();
    ~RegisterMechWheelDataCmdV1() override = default;
    ...
    const WheelData& GetWheelData() const override;
    uint8_t GetResult() const override;
};
} // namespace MechBodyController
} // namespace OHOS

#endif // MC_REGISTER_MECH_WHEEL_DATA_CMD_V1_H
