...
#ifndef MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
#define MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
...
class SetMechCameraTrackingLayoutCmdV2 : public SetMechCameraTrackingLayoutCmd {
public:
    ...
    explicit SetMechCameraTrackingLayoutCmdV2(const LayoutParams& params);
    ~SetMechCameraTrackingLayoutCmdV2() override = default;
...
#endif // MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
