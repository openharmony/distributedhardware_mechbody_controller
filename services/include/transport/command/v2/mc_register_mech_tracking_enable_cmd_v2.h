 ...
 */
#ifndef MC_REGISTER_MECH_TRACKING_ENABLE_CMD_V2_H
#define MC_REGISTER_MECH_TRACKING_ENABLE_CMD_V2_H
...
class RegisterMechTrackingEnableCmdV2 : public RegisterMechTrackingEnableCmd {
public:
    ...
    explicit RegisterMechTrackingEnableCmdV2();
    ~RegisterMechTrackingEnableCmdV2() override = default;
...
#endif // MC_REGISTER_MECH_TRACKING_ENABLE_CMD_V2_H
