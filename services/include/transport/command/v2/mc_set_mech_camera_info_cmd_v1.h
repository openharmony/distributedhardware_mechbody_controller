...
#ifndef MC_SET_MECH_CAMERA_INFO_CMD_V1_H
#define MC_SET_MECH_CAMERA_INFO_CMD_V1_H
...
class SetMechCameraInfoCmdV1 : public SetMechCameraInfoCmd {
public:
    ...
    explicit SetMechCameraInfoCmdV1(const CameraInfoParams& params);
    ~SetMechCameraInfoCmdV1() override = default;
...
#endif // MC_SET_MECH_CAMERA_INFO_CMD_V1_H
