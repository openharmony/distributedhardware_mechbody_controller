...
#ifndef MC_SET_MECH_ROTATE_CONTROL_CMD_V2_H
#define MC_SET_MECH_ROTATE_CONTROL_CMD_V2_H
...
class SetMechRotateControlCmdV2 : public SetMechRotateControlCmd {
public:
    ...
    SetMechRotateControlCmdV2(RotateControlType& rotateControlType);
    ~SetMechRotateControlCmdV2() override = default;
...
#endif // MC_SET_MECH_ROTATE_CONTROL_CMD_V2_H
