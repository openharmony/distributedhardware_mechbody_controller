...
#ifndef MC_SET_MECH_ROTATE_CONTROL_CMD_V1_H
#define MC_SET_MECH_ROTATE_CONTROL_CMD_V1_H

#include "mc_command_base.h"
#include "mechbody_controller_types.h"
#include "mc_set_mech_rotate_control_cmd.h"

namespace OHOS {
namespace MechBodyController {

class SetMechRotateControlCmdV1 : public SetMechRotateControlCmd {
public:
    ...
    SetMechRotateControlCmdV1(RotateControlType& rotateControlType);
    ~SetMechRotateControlCmdV1() override = default;
...
#endif // MC_SET_MECH_ROTATE_CONTROL_CMD_V1_H
