...
#ifndef MC_SET_MECH_ROTATION_TRACE_CMD_V2_H
#define MC_SET_MECH_ROTATION_TRACE_CMD_V2_H
...
class SetMechRotationTraceCmdV2 : public SetMechRotationTraceCmd {
public:
    ...
    explicit SetMechRotationTraceCmdV2(const std::vector<RotateParam>& params,
                                       const RotateTraceConfig config, const RotationAxesStatus& status);
    ~SetMechRotationTraceCmdV2() override = default;
...
#endif // MC_SET_MECH_ROTATION_TRACE_CMD_V2_H
