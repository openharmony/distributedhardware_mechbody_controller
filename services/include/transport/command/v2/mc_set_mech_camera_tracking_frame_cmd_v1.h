...
#ifndef MC_SET_MECH_CAMERA_TRACKING_FRAME_CMD_V1_H
#define MC_SET_MECH_CAMERA_TRACKING_FRAME_CMD_V1_H
...
class SetMechCameraTrackingFrameCmdV1 : public SetMechCameraTrackingFrameCmd {
public:
    ...
    explicit SetMechCameraTrackingFrameCmdV1(const TrackingFrameParams& params);
    ~SetMechCameraTrackingFrameCmdV1() override = default;
...
#endif // MC_SET_MECH_CAMERA_TRACKING_FRAME_CMD_V1_H
