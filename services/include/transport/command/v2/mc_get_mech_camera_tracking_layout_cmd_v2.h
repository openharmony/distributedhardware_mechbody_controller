...
#ifndef MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
#define MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
...
class GetMechCameraTrackingLayoutCmdV2 : public GetMechCameraTrackingLayoutCmd {
public:
    GetMechCameraTrackingLayoutCmdV2();
    ~GetMechCameraTrackingLayoutCmdV2() override = default;
...
#endif // MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_V2_H
