 ...
 */
#ifndef MC_REGISTER_MECH_POSITION_INFO_CMD_V2_H
#define MC_REGISTER_MECH_POSITION_INFO_CMD_V2_H
...
class RegisterMechPositionInfoCmdV2 : public RegisterMechPositionInfoCmd {
public:
    static constexpr uint8_t CMD_SET = 0x02;
    static constexpr uint8_t CMD_ID = 0x49;
    static constexpr uint16_t REQ_SIZE = 0;
    static constexpr uint16_t RSP_SIZE = 0;
    static constexpr uint16_t RPT_SIZE = 12;

    explicit RegisterMechPositionInfoCmdV2();
    ~RegisterMechPositionInfoCmdV2() override = default;
...
#endif // MC_REGISTER_MECH_POSITION_INFO_CMD_V2_H
