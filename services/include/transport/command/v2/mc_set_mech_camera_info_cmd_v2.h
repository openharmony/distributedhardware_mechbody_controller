...
#ifndef MC_SET_MECH_CAMERA_INFO_CMD_V2_H
#define MC_SET_MECH_CAMERA_INFO_CMD_V2_H
...
class SetMechCameraInfoCmdV2 : public SetMechCameraInfoCmd {
public:
    ...
    explicit SetMechCameraInfoCmdV2(const CameraInfoParams& params);
    ~SetMechCameraInfoCmdV2() override = default;
...
#endif // MC_SET_MECH_CAMERA_INFO_CMD_V2_H
