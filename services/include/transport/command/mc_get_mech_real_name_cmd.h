...
#ifndef MC_GET_MECH_REAL_NAME_CMD_H
#define MC_GET_MECH_REAL_NAME_CMD_H
...
class GetMechRealNameCmd : public CommandBase {
public:
    ...
    explicit GetMechRealNameCmd();
    ~GetMechRealNameCmd() override = default;
...
#endif // MC_GET_MECH_REAL_NAME_CMD_H
