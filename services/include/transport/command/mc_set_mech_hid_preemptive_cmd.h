...
#ifndef MC_SET_MECH_HID_PREEMPTIVE_CMD_H
#define MC_SET_MECH_HID_PREEMPTIVE_CMD_H
...
class SetMechHidPreemptiveCmd : public CommandBase {
public:
    ...
    explicit SetMechHidPreemptiveCmd(bool isPreemptive);
    ~SetMechHidPreemptiveCmd() override = default;
...
#endif // MC_SET_MECH_HID_PREEMPTIVE_CMD_H
