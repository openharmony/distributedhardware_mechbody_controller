...
#ifndef MC_NORMAL_SET_MECH_PROTOCOL_VER_CMD_H
#define MC_NORMAL_SET_MECH_PROTOCOL_VER_CMD_H
...
class NormalSetMechProtocolVerCmd : public CommandBase {
public:
    ...
    explicit NormalSetMechProtocolVerCmd(uint8_t protocolVer);
    ~NormalSetMechProtocolVerCmd() override = default;
...
#endif // MC_NORMAL_SET_MECH_PROTOCOL_VER_CMD_H
