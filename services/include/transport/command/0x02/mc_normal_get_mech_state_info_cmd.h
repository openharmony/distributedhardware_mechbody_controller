...
#ifndef MC_NORMAL_GET_MECH_STATE_INFO_CMD_H
#define MC_NORMAL_GET_MECH_STATE_INFO_CMD_H
...
class NormalGetMechStateInfoCmd : public CommandBase {
public:
    static constexpr uint8_t CMD_SET = 0x02;
    static constexpr uint8_t CMD_ID = 0x06;
    static constexpr uint16_t REQ_SIZE = 2;
    static constexpr uint16_t RSP_SIZE = 2;

    explicit NormalGetMechStateInfoCmd();
    ~NormalGetMechStateInfoCmd() override = default;
...
#endif // MC_NORMAL_GET_MECH_STATE_INFO_CMD_H
