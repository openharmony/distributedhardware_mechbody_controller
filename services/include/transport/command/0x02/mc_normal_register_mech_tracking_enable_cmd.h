 ...
 */
#ifndef MC_NORMAL_REGISTER_MECH_TRACKING_ENABLE_CMD_H
#define MC_NORMAL_REGISTER_MECH_TRACKING_ENABLE_CMD_H

#include "mc_command_base.h"
#include "mechbody_controller_types.h"
#include "mc_common_register_mech_tracking_enable_cmd.h"

namespace OHOS {
namespace MechBodyController {

class NormalRegisterMechTrackingEnableCmd : public CommonRegisterMechTrackingEnableCmd {
public:
    ...
    explicit NormalRegisterMechTrackingEnableCmd();
    ~NormalRegisterMechTrackingEnableCmd() override = default;
...
#endif // MC_NORMAL_REGISTER_MECH_TRACKING_ENABLE_CMD_H
