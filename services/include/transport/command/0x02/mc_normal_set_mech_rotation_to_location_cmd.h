...
#ifndef MC_NORMAL_SET_MECH_ROTATION_TO_LOCATION_CMD_H
#define MC_NORMAL_SET_MECH_ROTATION_TO_LOCATION_CMD_H
...
class NormalSetMechRotationToLocationCmd : public CommandBase {
public:
...
#endif // MC_NORMAL_SET_MECH_ROTATION_TO_LOCATION_CMD_H
