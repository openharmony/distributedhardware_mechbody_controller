 ...
 */
#ifndef MC_NORMAL_REGISTER_MECH_KEY_EVENT_CMD_H
#define MC_NORMAL_REGISTER_MECH_KEY_EVENT_CMD_H
...
class NormalRegisterMechKeyEventCmd : public CommonRegisterMechKeyEventCmd {
public:
    ...
    explicit NormalRegisterMechKeyEventCmd();
    ~NormalRegisterMechKeyEventCmd() override = default;
    ...
    const WheelData& GetWheelData() const;
...
#endif // MC_NORMAL_REGISTER_MECH_KEY_EVENT_CMD_H
