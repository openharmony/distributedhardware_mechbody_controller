 ...
 */
#ifndef MC_NORMAL_REGISTER_MECH_STATE_INFO_CMD_H
#define MC_NORMAL_REGISTER_MECH_STATE_INFO_CMD_H
#include "mc_command_base.h"
#include "mechbody_controller_types.h"
#include "mc_common_register_mech_state_info_cmd.h"

namespace OHOS {
namespace MechBodyController {

class NormalRegisterMechStateInfoCmd : public CommonRegisterMechStateInfoCmd {
public:
    ...
    explicit NormalRegisterMechStateInfoCmd();
    ~NormalRegisterMechStateInfoCmd() override = default;
...
#endif // MC_NORMAL_REGISTER_MECH_STATE_INFO_CMD_H
