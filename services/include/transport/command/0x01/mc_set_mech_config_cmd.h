...
#ifndef MC_SET_MECH_CONFIG_CMD_H
#define MC_SET_MECH_CONFIG_CMD_H
...
class SetMechConfigCmd : public CommandBase {
public:
    ...
    explicit SetMechConfigCmd(uint8_t configVersion);
    ~SetMechConfigCmd() override = default;
...
private:
    uint8_t result_ = 0;
    uint8_t configVersion_ = 0;
};

} // namespace MechBodyController
} // namespace OHOS

#endif // MC_SET_MECH_CONFIG_CMD_H
