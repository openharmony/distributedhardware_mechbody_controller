...
#ifndef MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
#define MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
...
class SetMechCameraTrackingLayoutCmd : public CommandBase {
public:
    ...
    explicit SetMechCameraTrackingLayoutCmd(const LayoutParams& params);
    ~SetMechCameraTrackingLayoutCmd() override = default;
...
#endif // MC_SET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
