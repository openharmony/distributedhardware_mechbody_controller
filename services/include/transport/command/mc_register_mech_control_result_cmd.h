 ...
 */
#ifndef MC_REGISTER_MECH_CONTROL_RESULT_CMD_H
#define MC_REGISTER_MECH_CONTROL_RESULT_CMD_H
...
class RegisterMechControlResultCmd : public CommandBase {
public:
    ...
    explicit RegisterMechControlResultCmd();
    ~RegisterMechControlResultCmd() override = default;
    ...
    uint8_t GetControlResult() const;
    uint8_t GetResult() const;
    uint8_t GetTaskId() const;

private:
    uint8_t controlResult_ = 0;
    uint8_t result_ = 0;
    uint8_t taskId_ = 0;
};
...
#endif // MC_REGISTER_MECH_CONTROL_RESULT_CMD_H
