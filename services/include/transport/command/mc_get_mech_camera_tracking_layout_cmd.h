...
#ifndef MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
#define MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
...
class GetMechCameraTrackingLayoutCmd : public CommandBase {
public:
    ...
    explicit GetMechCameraTrackingLayoutCmd();
    ~GetMechCameraTrackingLayoutCmd() override = default;
...
#endif // MC_GET_MECH_CAMERA_TRACKING_LAYOUT_CMD_H
