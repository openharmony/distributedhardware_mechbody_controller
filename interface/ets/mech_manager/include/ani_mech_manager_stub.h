...
#ifndef ANI_MECH_MANAGER_STUB_H
#define ANI_MECH_MANAGER_STUB_H
...
class AniMechManagerStub : public IRemoteStub<IJsMechManager> {
public:
    AniMechManagerStub();
    virtual ~AniMechManagerStub();
...
private:
    using MechManagerFunc = int32_t(AniMechManagerStub::*)(MessageParcel &data, MessageParcel &reply);
